...
import com.example.motion.commmon.bean.UserAccount;
import com.example.motion.commmon.utils.Conn;
import com.example.motion.commmon.utils.LogUtils;
import com.example.motion.commmon.utils.UIHelper;
import com.example.motion.commmon.utils.Utils;
...
public class RegistActivity extends BaseActivity {
    ...
    @OnClick({R2.id.container, R2.id.rlBadk, R2.id.chronometer, R2.id.bt_regist})
    public void onViewClicked(View view) {
        int id = view.getId();
        if (id == R.id.container) {// 设置点击影藏输入法
            hideSoftKeyBoard();
