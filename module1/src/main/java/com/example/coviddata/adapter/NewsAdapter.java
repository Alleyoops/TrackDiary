package com.example.coviddata.adapter;
...
import com.example.coviddata.entity.soJsonJson.EpidemicNews;
import com.example.coviddata.R;
import com.example.coviddata.ui.third.NewsOnBrowserFragment;
    ...
    public void onBindViewHolder(@NonNull @NotNull NewsViewHolder holder, int position) {
        ...
        holder.newsUrl.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                FragmentTransaction transaction = ((MainActivity2) context).getSupportFragmentManager().beginTransaction();
