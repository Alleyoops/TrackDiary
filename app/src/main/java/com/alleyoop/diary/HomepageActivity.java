...
import com.example.coviddata.MainActivity2;
import com.example.motion.ui.activity.HomeActivity;
import com.example.motion.ui.activity.PlanActivity;
import com.example.motion.ui.activity.SportsActivity;
...
public class HomepageActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String url = sp.getString("url","https://news.quark.cn/dailynews/v2/newslist?entry=share&aggId=10030353982341395159&pre_page=ribao_home");
        webView.loadUrl(url);
        ...
        PressAnimUtil.addScaleAnimition(findViewById(R.id.card22), new View.OnClickListener() {
            ...
            public void onClick(View v) {
                new Handler().postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        startActivity(new Intent().setClass(HomepageActivity.this,MainActivity2.class));
                    }
                },200);
        ...
        PressAnimUtil.addScaleAnimition(findViewById(R.id.card5), new View.OnClickListener() {
            ...
            public void onClick(View v) {
                new Handler().postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        startActivity(new Intent().setClass(HomepageActivity.this, SportsActivity.class));
                    }
                },200);

            }
        },0.8f);
        PressAnimUtil.addScaleAnimition(findViewById(R.id.card11), new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                new Handler().postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        startActivity(new Intent().setClass(HomepageActivity.this, HomeActivity.class));
                    }
                },200);
