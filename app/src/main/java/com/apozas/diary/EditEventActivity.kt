...
import com.apozas.diary.R
import com.apozas.diary.databinding.ActivityAddeventInsideBinding
import com.apozas.diary.databinding.ActivityEditeventBinding
...
//      Get info from MainActivity
        ...
        elements.eventnameInput.setText(cursor.getString(cursor.getColumnIndexOrThrow(
            ContactDatabase.ContactDatabase.FeedEntry.NAME_COLUMN
        )))
        elements.eventplaceInput.setText(cursor.getString(cursor.getColumnIndexOrThrow(
        ...
        if (cursor.getString(cursor.getColumnIndexOrThrow(ContactDatabase.ContactDatabase.FeedEntry.COMPANIONS_COLUMN)) != ""){
            elements.eventpeopleInput.setText(cursor.getString(cursor.getColumnIndexOrThrow(
        ...
        if (cursor.getString(cursor.getColumnIndexOrThrow(ContactDatabase.ContactDatabase.FeedEntry.PHONE_COLUMN)) != ""){
            elements.eventphoneInput.setText(cursor.getString(cursor.getColumnIndexOrThrow(
        ...
        elements.eventnotesInput.setText(cursor.getString(cursor.getColumnIndexOrThrow(
